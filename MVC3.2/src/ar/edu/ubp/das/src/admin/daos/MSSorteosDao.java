...
public class MSSorteosDao extends DaoImpl{
	...
	public DynaActionForm make(ResultSet result) throws SQLException {
    	...
    	sorteo.setDni(result.getInt("dni"));
    	sorteo.setMail(result.getString("mail"));
    	sorteo.setProvincia(result.getString("provincia"));
	...
	public void insert(DynaActionForm form) throws SQLException {
		...
		this.setProcedure("dbo.cargar_sorteo(?)"); 

		this.setParameter(1, form.getItem("fechaSorteo"));
