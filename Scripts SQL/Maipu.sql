...
insert into autos(id_marca,id_modelo,id_version,dominio,num_motor,num_chasis,año,color) values
    (3,1,1,'CCC121','OVU765ASDFSDDFF','Y78IJADSFDFSUVO',2012,'Celeste'),
    (3,1,2,'CCC122','AVU765H8LKJI87Y','Y78IJKLFFFFFFVA',2013,'Celeste'),
    (6,1,1,'CCC123','BBBB65H8LKJI87Y','Y78IJKL8H56HHHB',2013,'Cielo'),
    (6,1,2,'CCC124','BVU765H8LKJI87Y','Y78IJKL8H56RTYS',2014,'Celeste'),
    (7,1,1,'CCC125','CVU765H8LKJI87Y','Y78IJKL8HRGGRVC',2015,'Cielo'),
    (7,2,1,'CCC126','DVU765H8LKJI87Y','Y78IJKL8GFDFGVD',2016,'Celeste'),
    (7,3,1,'CCC127','EVU765H8LKJI87Y','Y78IJKL8H567UVE',2017,'Celeste Oscuro')
go
-----------------------------------------------------------------------
...
insert into clientes(nombre,apellido,dni,mail,telefono,id_provincia,id_localidad,direccion) values
  ('Agustin','Coutinho','11111111','acoutinho@gmail.com','3512262941',5,2,'Donato Alvarez 380'),
  ('Fernando','Cazal','11111112','fercazal@gmail.com','3515456466',5,2,'Arrambide 6239'),
  ('Hernan','Malatini','11111113','hmalatini@gmail.com','3515433942',5,5,'Uriburu 6239'),
  ('Facundo','Baigorria','11111114','facubaigorria@gmail.com','355433942',1,4,'Josefe 6239'),
  ('Francisco','Gait','11111115','fgait@gmail.com','3513354342',1,5,'Chochi 6239')
go
-----------------------------------------------------------------------
