...
insert into autos(id_marca,id_modelo,id_version,dominio,num_motor,num_chasis,año,color) values
    (3,1,1,'EEE121','OVU765ASDFSDDFF','Y78IJADSFDFSUVO',2012,'Escarlata Gobelinos'),
    (3,1,2,'EEE122','AVU765H8LKJI87Y','Y78IJKLFFFFFFVA',2013,'Escarlata'),
    (6,1,1,'EEE123','BBBB65H8LKJI87Y','Y78IJKL8H56HHHB',2013,'Esmeralda Claro'),
    (6,1,2,'EEE124','BVU765H8LKJI87Y','Y78IJKL8H56RTYS',2014,'Esmeralda'),
    (7,1,1,'EEE125','CVU765H8LKJI87Y','Y78IJKL8HRGGRVC',2015,'Esmeralda Fuerte'),
    (7,2,1,'EEE126','DVU765H8LKJI87Y','Y78IJKL8GFDFGVD',2016,'Escarlata'),
    (7,3,1,'EEE127','EVU765H8LKJI87Y','Y78IJKL8H567UVE',2017,'Esmeralda')
go
-----------------------------------------------------------------------
...
insert into clientes(nombre,apellido,dni,mail,telefono,id_provincia,id_localidad,direccion) values
  ('Uriel','Lesta','11111111','ulesta@gmail.com','3512262941',5,2,'Donato Alvarez 380'),
  ('Yamila','Galliano','11111112','yamigall@gmail.com','3515456466',5,2,'Arrambide 6239'),
  ('Mariano','Schmidt','11111113','nanoschmidt@gmail.com','3515433942',5,5,'Uriburu 6239'),
  ('Franco','Margaria','11111114','fmargaria@gmail.com','355433942',1,4,'Josefe 6239'),
  ('Guido','Giovaninni','11111115','guidogiova@gmail.com','3513354342',1,5,'Chochi 6239')
go
-----------------------------------------------------------------------
