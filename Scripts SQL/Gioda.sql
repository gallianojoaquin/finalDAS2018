...
insert into autos(id_marca,id_modelo,id_version,dominio,num_motor,num_chasis,año,color) values
    (3,1,1,'AAA121','OVU765ASDFSDDFF','Y78IJADSFDFSUVO',2012,'Azul'),
    (3,1,2,'AAA122','AVU765H8LKJI87Y','Y78IJKLFFFFFFVA',2013,'Amarillo'),
    (6,1,1,'AAA123','BBBB65H8LKJI87Y','Y78IJKL8H56HHHB',2013,'Aluminio'),
    (6,1,2,'AAA124','BVU765H8LKJI87Y','Y78IJKL8H56RTYS',2014,'Alabastar'),
    (7,1,1,'AAA125','CVU765H8LKJI87Y','Y78IJKL8HRGGRVC',2015,'Azul claro'),
    (7,2,1,'AAA126','DVU765H8LKJI87Y','Y78IJKL8GFDFGVD',2016,'Azul oscuro'),
    (7,3,1,'AAA127','EVU765H8LKJI87Y','Y78IJKL8H567UVE',2017,'Azul francia')
go
-----------------------------------------------------------------------
...
insert into clientes(nombre,apellido,dni,mail,telefono,id_provincia,id_localidad,direccion) values
  ('Mariela','Pastarini','11111111','mpastarini@ubp.edu.ar','3512262941',5,2,'Donato Alvarez 380'),
  ('Augusto','Gavier','11111112','auggavier@gmail.com','3515456466',5,2,'Arrambide 6239'),
  ('Juan','Peugoso','11111113','jup@gmail.com','3515433942',5,5,'Uriburu 6239'),
  ('Jorge','Molinari','11111114','jor_molin@gmail.com','355433942',1,4,'Josefe 6239'),
  ('Cesar','Tanglo','11111115','ces_tanglo@gmail.com','3513354342',1,5,'Chochi 6239')
go
-----------------------------------------------------------------------
