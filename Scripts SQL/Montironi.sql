...
insert into autos(id_marca,id_modelo,id_version,dominio,num_motor,num_chasis,año,color) values
    (3,1,1,'DDD121','OVU765ASDFSDDFF','Y78IJADSFDFSUVO',2012,'Dorado'),
    (3,1,2,'DDD122','AVU765H8LKJI87Y','Y78IJKLFFFFFFVA',2013,'Diamante'),
    (6,1,1,'DDD123','BBBB65H8LKJI87Y','Y78IJKL8H56HHHB',2013,'Dorado'),
    (6,1,2,'DDD124','BVU765H8LKJI87Y','Y78IJKL8H56RTYS',2014,'Dorado Champagne'),
    (7,1,1,'DDD125','CVU765H8LKJI87Y','Y78IJKL8HRGGRVC',2015,'Dorado Amarillento'),
    (7,2,1,'DDD126','DVU765H8LKJI87Y','Y78IJKL8GFDFGVD',2016,'Diamante Perlado'),
    (7,3,1,'DDD127','EVU765H8LKJI87Y','Y78IJKL8H567UVE',2017,'Diamante')
go
-----------------------------------------------------------------------
...
insert into clientes(nombre,apellido,dni,mail,telefono,id_provincia,id_localidad,direccion) values
  ('Romina','Nicastro','11111111','nicastror@gmail.com','3512262941',5,2,'Donato Alvarez 380'),
  ('Agustina','Demalde','11111112','ademalde@gmail.com','3515456466',5,2,'Arrambide 6239'),
  ('Lucia','Blanc','11111113','lblanc@gmail.com','3515433942',5,5,'Uriburu 6239'),
  ('Franco','Trombotto','11111114','trumba@gmail.com','355433942',1,4,'Josefe 6239'),
  ('Diego','Hernandez','11111115','dhernandez@gmail.com','3513354342',1,5,'Chochi 6239')
go
-----------------------------------------------------------------------
